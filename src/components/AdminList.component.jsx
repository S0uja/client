...
const AdminListComponent = (props) => {
    return (
        ...
        >
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('dashboard')}>
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('personal')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('products')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('users')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('manufacturers')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('categories')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('orders')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('collections')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
            ...
            <ListItemButton sx={{borderRadius:2,minWidth:'170px'}} onClick={()=>props.onChange('order_statuses')}>
                <ListItemAvatar sx={{ minWidth: 40 }}>
                    <Avatar 
                        variant="rounded"
                        sx={{ width: 24, height: 24, bgcolor:'#404040' }}
                ...
                <ListItemText primaryTypographyProps={font} primary={'Статусы заказа'}/>
            </ListItemButton>
