...
import { getProducts } from '../http/Admin.http';
import font from '../themes/font.theme'
import { setAdminProductModal, setSnackbarModal } from '../store/modals.store'
import {deleteProduct} from '../http/Admin.http'
import AdminProductsModal from '../modals/AdminProduct.modal';
import {getCategories,getManufacturers} from '../http/Admin.http'
...
const ProductsComponent = () => {
    ...
    return (
        <>
            <AdminProductsModal handleUpdate={updateData} categories={categories} manufacturers={manufacturers} updateId={updateId}/>
            
            <Paper sx={{height:'100%', width: '100%', overflow: 'hidden',p:2,borderRadius:2,boxSizing:'border-box'}} elevation={0}>
                <Typography sx={{...font,fontSize:'24px',width:'100%'}}>Товары</Typography>
