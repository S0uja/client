...
const AdminDashboardCardComponent = (props) => {
  ...
  return (
    <Box sx={{
        ...
        <Box sx={{display:'flex',position:'relative',justifyContent:'space-around',alignItems:'center',gap:4,flex:1}}>
            <Box sx={{position:'absolute',bottom:8,textAlign:'center',width:'100%',fontSize:18}}>{props.title}</Box>
