  ...
  return (
    <Paper sx={{ width: '100%', overflow: 'hidden'}} elevation={0}>
      ...
      <Box sx={{display:'flex',flexDirection:'column',gap:1,py:2}}>
        <Box sx={{width:'100%',display:'flex',flexDirection:{es:'column',md:'row'},gap:2}}>
          <Search onChange={handleSearch} onClear={cancelSearch}/>
          {
            !props.onlyRead===true && (
              <Box sx={{display:'flex',gap:2,justifyContent:'end'}}>
                ...
                <IconButton onClick={props.handleUpdate}><CachedIcon/> </IconButton>
              </Box>
            )
          }
        </Box>
          ...
          <TableBody>
            {
              ...
              (
                  ...
                  rows
                    ...
                    .map((row,i) => {
                        ...
                        <TableRow hover role="checkbox" tabIndex={-1} key={i}>
                            ...
                            {
                              !props.onlyRead===true && (
                                <TableCell sx={{...font,fontWeight:400,width:'80px'}} align={'right'}>
                                  <Box sx={{display:'flex'}}>
                ...
                (
                    <TableRow >
                        <TableCell colSpan={props.columns.length+1} align="center" sx={{...font,color:'#787878',fontSize:'16px',width:'100%',textAlign:'center'}}>
                          <IconButton onClick={props.handleUpdate}><CachedIcon/> </IconButton>
                        </TableCell>
                    </TableRow>
                )
