...
export const getUser = async (id) => {
    try {
        ...
        const {data} = await $authHost.get(`api/user/admin/${id}`, {timeout: 6000})
...
export const updateUser = async (id,number,fio,role,birthdate) => {
    try {
        ...
        const {data} = await $authHost.put(`api/user/admin/${id}`,formdata, {timeout: 6000})
...
export const deleteProduct = async (id) => {
    try {
        ...
        const {data} = await $authHost.delete(`api/product/${id}`, {timeout: 6000})
...
export const createProduct = async (name,price,amount,description,expirationdate,storageconditions,structure,weight_volume,categoryId,manufacturerId,images) => {
    try {
        ...
        const {data} = await $authHost.post(`api/product/`,formdata, {timeout: 6000})
...
export const updateProduct = async (id,name,price,amount,description,expirationdate,storageconditions,structure,weight_volume,categoryId,manufacturerId,images) => {
    try {
        ...
        const {data} = await $authHost.put(`api/product/${id}`,formdata, {timeout: 6000})
...
export const updateManufacturer = async (id,name,description,contact,filename) => {
    try {
        ...
        const {data} = await $authHost.put(`api/manufacturer/${id}`,formdata, {timeout: 6000})
...
export const deleteManufacturer = async (id) => {
    try {
        ...
        const {data} = await $authHost.delete(`api/manufacturer/${id}`, {timeout: 6000})
...
export const createManufacturer = async (name,description,contact,filename) => {
    try {
        console.log('TRY CREATE PRODUCT');
        ...
        const {data} = await $authHost.post(`api/manufacturer/`,formdata, {timeout: 6000})
...
export const getManufacturer = async (id) => {
    try {
        ...
        const {data} = await $authHost.get(`api/manufacturer/${id}`, {timeout: 6000})
...
export const updateCategory = async (id,name,parentId,filename) => {
    try {
        ...
        const {data} = await $authHost.put(`api/category/${id}`,formdata, {timeout: 6000})
...
export const deleteCategory = async (id) => {
    try {
        ...
        const {data} = await $authHost.delete(`api/category/${id}`, {timeout: 6000})
...
export const createCategory = async (name,parentId,filename) => {
    try {
        ...
        const {data} = await $authHost.post(`api/category/`,formdata, {timeout: 6000})
...
export const getCategory = async (id) => {
    try {
        ...
        const {data} = await $authHost.get(`api/category/${id}`, {timeout: 6000})
...
export const updateCollection = async (id,name,visible,products) => {
    try {
        ...
        const {data} = await $authHost.put(`api/collection/${id}`,formdata, {timeout: 6000})
...
export const deleteCollection = async (id) => {
    try {
        ...
        const {data} = await $authHost.delete(`api/collection/${id}`, {timeout: 6000})
...
export const createCollection = async (name,visible,products) => {
    try {
        ...
        const {data} = await $authHost.post(`api/collection/`,formdata, {timeout: 6000})
...
export const getCollection = async (id) => {
    try {
        ...
        const {data} = await $authHost.get(`api/collection/${id}`, {timeout: 6000})
...
export const updateOrder = async (id,address, products, price, userId, orderStatusId) => {
    try {
        ...
        products.forEach(product=>{
            formdata.append('products[]', JSON.stringify({id:product.id,count:product.count}))
        })

        const {data} = await $authHost.put(`api/order/admin/${id}`,formdata, {timeout: 6000})
...
export const deleteOrder = async (id) => {
    try {
        ...
        const {data} = await $authHost.delete(`api/order/admin/${id}`, {timeout: 6000})
...
export const createOrder = async (address, products, price, userId, orderStatusId) => {
    try {
        ...
        const {data} = await $authHost.post(`api/order/admin/`,formdata, {timeout: 6000})
...
export const getOrder = async (id) => {
    try {
        ...
        const {data} = await $authHost.get(`api/order/admin/${id}`, {timeout: 6000})
...
export const updateOrderStatus = async (id,name) => {
    try {
        ...
        const {data} = await $authHost.put(`api/orderStatus/${id}`,formdata, {timeout: 6000})
...
export const deleteOrderStatus = async (id) => {
    try {
        ...
        const {data} = await $authHost.delete(`api/orderStatus/${id}`, {timeout: 6000})
...
export const createOrderStatus = async (name) => {
    try {
        ...
        const {data} = await $authHost.post(`api/orderStatus/`,formdata, {timeout: 6000})
...
export const getOrderStatus = async (id) => {
    try {
        ...
        const {data} = await $authHost.get(`api/orderStatus/${id}`, {timeout: 6000})
...
export const getMounthOrdersCount = async () => {
    try {
        ...
        const {data} = await $authHost.get(`api/statistic/orders`, {timeout: 6000})
...
export const getMounthEarn = async () => {
    try {
        ...
        const {data} = await $authHost.get(`api/statistic/earn`, {timeout: 6000})
...
export const getLogs = async () => {
    try {
        ...
        const {data} = await $authHost.get(`api/statistic/logs`, {timeout: 6000})
