...
const CategoryModal = (props) => {
    const CategoryModalStatus=useSelector(state => state.modals.adminCategoryModal)
            ...
            <Box sx={{...modal,minHeight:'450px',maxWidth:'350px',justifyContent:'start',flexDirection:'column'}}>
...

                {
                    ...
                    <Box sx={{width:'100%',height:'100%'}}>
                        <Box sx={{...font,fontSize:'22px',mt:2,mb:3,textAlign:'center'}}>{mode==='create'?'Новая категория':'Редактирование'}</Box>
